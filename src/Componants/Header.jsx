...
export default function Header() {
    return (
        ...
        <div className='w-full h-dvh overflow-auto'>
            < div className=" w-full h-[20dvh] bg-[url('https://assets.nicepagecdn.com/d2cc3eaa/2882063/images/Untitled-2-min.png')] bg-no-repeat bg-cover bg-top rounded-b-[10px]">
